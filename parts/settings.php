...
<div class="wrap">
	...
	<div class="google-analytics-connection">
		...
		<?php if ( Admin::get_google_auth_details() ) :
		?>
		<button class="button-primary" disabled="disabled"><?php
			esc_html_e( 'Connected to Google Analytics', 'google-analytics-bridge' ); ?></button>
			...
			href="<?php echo esc_url( Admin::get_disconnect_callback_url() ); ?>"><?php
			esc_html_e( 'Disconnect Google Analytics', 'google-analytics-bridge' ); ?></a>
		<?php else : ?>
